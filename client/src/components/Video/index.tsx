...
let Video = React.forwardRef<HTMLVideoElement, Ivideo>(
  (
    { controls = true, main = false, style = { width: 720 }, stream },
    forwardedRef
  ) => {
    ...
    return (
      <VidStyles style={style}>
        <div className="vid_controls"></div>
